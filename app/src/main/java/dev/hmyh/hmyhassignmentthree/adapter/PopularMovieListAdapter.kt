...
class PopularMovieListAdapter(val delegate: MovieListDelegate): BaseRecyclerAdapter<PopularMovieListViewHolder, MovieListVO>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PopularMovieListViewHolder {
        ...
        return PopularMovieListViewHolder(view,delegate)
    }
