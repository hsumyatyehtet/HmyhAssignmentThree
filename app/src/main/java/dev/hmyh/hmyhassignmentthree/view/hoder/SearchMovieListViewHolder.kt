...
import kotlinx.android.synthetic.main.view_holder_in_movie_list.view.tvMovieTitle
import kotlinx.android.synthetic.main.view_holder_in_movie_search.view.*

class SearchMovieListViewHolder(itemView: View,delegate: MovieListDelegate):
